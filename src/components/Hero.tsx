...
const Hero = () => {
  return (
    <div className='flex flex-col md:flex-row mt-20 md:mt-40 my-10 md:my-14 mx-3 md:mx-20 max-h-full '>
      ...
      <div className='w-full md:w-1/2 flex justify-center items-center mt-8 md:mt-0'>
        <Image src="/hero.png" width={999} height={999} alt='heroimage' className='h-[18rem] md:h-[30rem] w-full object-cover' />
      </div>
    </div>
